...
:exclamation: You can either use the your solution from Task 1 to move forward or use the given solution [Grid task 1 solution](https://codepen.io/mariuskalvo/pen/raaYNKN)
Solution can be found here: [Grid task 2 solution](https://codepen.io/mariuskalvo/pen/azzVbRN) 
